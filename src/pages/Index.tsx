            ...
            <div className="max-w-4xl mx-auto">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="section-card">
                ...
                <div className="space-y-3 text-muted-foreground leading-relaxed text-sm">
                  <p>Startups and product teams hire me when they need complex systems built fast — without the usual tradeoffs between speed, quality, and scale. In over 10 years shipping production software, I've taken projects from zero to live across fintech, e-commerce, booking, and AI — including a full booking system rewrite that exceeded every performance target the team set.</p>
                  <p>My work sits at the intersection of full-stack engineering and AI integration. If you're building something that needs a solid backend, a polished frontend, and intelligence baked in — whether that's an LLM workflow, a voice agent, or a real-time data layer — that's exactly where I operate. I've shipped AI-powered platforms using LangChain, LangGraph, ElevenLabs, Whisper, and VAPI, and I understand how to make those tools reliable in production, not just in demos.</p>
                  <p>I work well with founders and engineering leads who need someone who can own a problem end-to-end — architecture, implementation, and delivery — without needing their hand held through every decision. If that's the kind of engineer you're looking for, let's talk.</p>
                </div>
              </motion.div>
            </div>
          </div>

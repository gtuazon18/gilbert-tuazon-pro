...
const galleryHighlights = [
  ...
  { src: "/ShowAndTellMeetup/758793846_4315085988755472_2795391048776258519_n.jpg", alt: "AppBuildersPH Show and Tell meetup presentation" },
  { src: "/ShowAndTellMeetup/759823643_4315388242058580_6623473828014392724_n.jpg", alt: "AppBuildersPH Show and Tell meetup" },
  { src: "/ShowAndTellMeetup/759330298_4315388672058537_6482736134556077266_n.jpg", alt: "AppBuildersPH Show and Tell attendees" },
];
    ...
    <div className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <main id="top">
        ...
        <section className="py-16 md:py-24"><div className="mx-auto max-w-6xl px-5 md:px-8"><Reveal><p className="section-kicker">Beyond the build</p><h2 className="mt-4 max-w-3xl text-4xl font-semibold tracking-[-0.04em] md:text-6xl">The work, the people, and the things I share along the way.</h2></Reveal><div className="mt-12 grid gap-5 lg:grid-cols-[1.35fr_0.65fr]">
          <Reveal className="rounded-3xl border border-border bg-card p-5 md:p-7"><div className="flex items-end justify-between gap-4"><div><p className="section-kicker">Gallery</p><h3 className="mt-3 text-2xl font-semibold">Projects and community moments</h3></div><Link to="/gallery" className="hidden items-center gap-2 text-sm font-semibold hover:underline sm:inline-flex">Project archive <ArrowRight className="h-4 w-4" /></Link></div><div className="mt-6 grid grid-cols-3 gap-2.5"><div className="col-span-2 row-span-2 aspect-[4/3] overflow-hidden rounded-2xl bg-secondary"><img src={galleryHighlights[0].src} alt={galleryHighlights[0].alt} className="h-full w-full object-cover transition-transform duration-500 hover:scale-105" loading="lazy" /></div>{galleryHighlights.slice(1, 5).map(image => <div key={image.src} className="aspect-square overflow-hidden rounded-2xl bg-secondary"><img src={image.src} alt={image.alt} className="h-full w-full object-cover transition-transform duration-500 hover:scale-105" loading="lazy" /></div>)}</div><Link to="/gallery" className="mt-5 inline-flex items-center gap-2 text-sm font-semibold hover:underline sm:hidden">Project archive <ArrowRight className="h-4 w-4" /></Link></Reveal>

...
const Index = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <footer className="border-t border-border py-8"><div className="mx-auto flex max-w-6xl flex-col gap-5 px-5 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between md:px-8"><p>© {new Date().getFullYear()} Gilbert Tuazon</p><div className="flex items-center gap-5"><a href="https://github.com/gtuazon18/gtuazon18" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 hover:text-foreground"><Github className="h-4 w-4" /> GitHub</a><a href="https://www.linkedin.com/in/gilbert-t-20a96213a/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 hover:text-foreground"><Linkedin className="h-4 w-4" /> LinkedIn</a><a href="mailto:tuazon548@gmail.com" className="inline-flex items-center gap-1.5 hover:text-foreground"><Mail className="h-4 w-4" /> Email</a></div></div></footer>
    </div>
  );
};

...
import {
  ...
  FlaskConical, Mic, AudioLines, FileText, ArrowLeft, Search, Home,
} from "lucide-react";
...
const galleryProjects: GalleryProject[] = [
  ...
  { title: "Lead Generation Platform", description: "Comprehensive CRM with lead scoring and automation", tech: ["React", "Laravel", "MySQL", "Elasticsearch"], color: "bg-indigo-50", icon: Users, live: "https://www.intelhouse.net/" },
